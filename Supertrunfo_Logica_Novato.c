...
int main(){
    ...
    float den1, den2; //densidade populacional
    ...
    den1 = (float)populacao1 / area1;//cáculo da densidade populacional
    ...
    pibc1 = pib1 / (float)populacao1;//cálculo do pib per capita
    ...
    scanf(" %d" , &pt1);
    //Aqui foi finalizada a criação da primeira carta
    ...
    den2 = (float)populacao2 / area2;//cáculo da densidade populacional

    printf("Estamos quase lá! Agora prossiga em digitar o PIB mais recente publicado da cidade\n");
    printf("Por favor, digite o PIB da cidade:\n");
    scanf(" %f" , &pib2);

    pibc2 = pib2 / (float)populacao2;//cálculo do pib per capita
    ...
    printf("\n--- Comparação de Cartas ---\n"); // inicio da comparação dos atributos das cartas
